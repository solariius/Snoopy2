...
export default class CenaJogo extends Phaser.Scene {
    ...
    create() {
        ...
        const imagemFundo = this.add.image(0, 0, 'fundo');
        imagemFundo.setOrigin(0, 0);
        imagemFundo.setDisplaySize(400,240);

        const plataformas = this.physics.add.staticGroup();
        plataformas.create(0, 184, 'chao').setOrigin(0, 0).setDisplaySize(400,50).refreshBody();
        plataformas.create(400 - 40, 240 - 56 - 34 - 14, 'platform').setOrigin(0, 0).refreshBody();
        plataformas.create(400 - 100, 240 - 56 - 24, 'platform').setOrigin(0, 0).refreshBody();
